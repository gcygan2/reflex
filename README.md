...
1. Wejdź w Narzędzia → Płytka → Menedżer płytek.
1. Wyszukaj ESP32 by Espressif Systems i kliknij Instaluj.
1. Wybór odpowiedniej płytki
1. Po instalacji wejdź w Narzędzia → Płytka → ESP32 Arduino.
1. Wybierz DOIT ESP32 DEVKIT V1 – to jest właściwa opcja dla Twojej płytki ESP32 Devkit V1.
## Konfiguracja portu i upload
1. Podłącz płytkę przez USB.
